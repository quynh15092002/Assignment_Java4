						...
						<div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${ sessionScope.lstCart }" var="cart">
											<tr>
												<th scope="row">
													<div class="p-2">
														<img src="${cart.value.product.img}" alt="" width="70"
															class="img-fluid rounded shadow-sm">
														<div class="ml-3 d-inline-block align-middle">
															<h5 class="mb-0">
																<a href="#" class="text-dark d-inline-block">${cart.value.product.ten}</a>
															</h5>
															<span class="text-muted font-weight-normal font-italic"></span>
														</div>
													</div>
												</th>
												<td class="align-middle"><strong>${cart.value.product.donGia}</strong></td>
												<td class="align-middle"><a href=""><button
															class="btnSub">-</button></a> <strong>${cart.value.amount}</strong>
													<a href="/Quynh_IT16302_ASM/CartController"><button
															class="btnAdd">+</button></a></td>
												<td class="align-middle"><a href="" class="text-dark">
														<form action="/Quynh_IT16302_ASM/CartController/delete?id=${cart.key }"
															method="post">
							...
							<div class="p-4">
								<ul class="list-unstyled mb-4">
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">Tổng tiền hàng</strong><strong>${total}</strong>
										<h5 class="font-weight-bold"> ${sessionScope.sum }</h5></li></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
									...
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										...
										<h5 class="font-weight-bold"> ${sessionScope.sum }</h5></li>
								</ul>
